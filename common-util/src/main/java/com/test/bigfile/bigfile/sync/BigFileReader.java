...
public class BigFileReader {
    ...
    private BigFileReader(File file, IHandle handle, String charset, int bufferSize, int threadSize) {
        ...
        this.doneSign = new CountDownLatch(threadSize);
    ...
    public void start() {
        ...
        for (StartEndPair pair : startEndPairs) {
            ...
            this.executorService.execute(new SliceReaderTask(pair, this.doneSign));
        }
        try {
            this.doneSign.await();
    ...
    private class SliceReaderTask implements Runnable {
        ...
        public SliceReaderTask(StartEndPair pair, CountDownLatch doneSign) {
    ...
    public static class Builder {
        ...
        private int bufferSize = 1024 * 1024;//1M缓存
        private IHandle handle;
        private File file;
