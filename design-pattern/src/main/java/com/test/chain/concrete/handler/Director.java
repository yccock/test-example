package com.test.chain.concrete.handler;

import com.test.chain.LeaveRequest;
...
public class Director extends Leader{
    ...
    public void handleRequest(LeaveRequest request) {
        ...
        if(days <= 3) { //如果满足3天内的要求，主任直接审批
            ...
            if(super.nextLeader != null) { //否则，如果链上存在下一个Leader，就让他处理
                super.nextLeader.handleRequest(request);
            }
        }
    }
}
